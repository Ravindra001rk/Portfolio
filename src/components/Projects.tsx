                ...
                <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-between">
                  <div>
                    ...
                    <motion.p
                      ...
                      className="leading-relaxed text-base md:text-lg mb-8 max-w-lg"
                    ...
                    >
                      {project.tags.map((t, i) => (
                        <motion.span
                          ...
                          className="px-3 py-1 rounded-full text-xs font-medium border border-white/10 bg-white/5"
                          style={{ color: "var(--color-text-muted)" }}
                        >
                          {t}
                        </motion.span>
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      {project.liveUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="flex items-center gap-2 border border-white/10 hover:border-white/30 px-6 py-3.5 rounded-full font-medium text-sm transition-all"
                          style={{ color: "var(--color-text-muted)" }}
                        >
